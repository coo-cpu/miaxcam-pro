...
The OTA provides an open-loop gain of \SI{41.5}{\deci\bel} and a unity-gain bandwidth of \SI{98.99}{\mega\hertz} under a differential input, supporting the DAC's current-to-voltage conversion. 
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{Schematic.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{NMOS.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{PMOS.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{Open_Loop.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{UGB.png}}
\caption{open-loop gain and Unity Gain Bandwidth check}
\label{fig:ugb}
\end{figure}
In Figure \ref{fig:ugb}, we obtain an open-loop gain of \SI{41.5}{\deci\bel} and a unity-gain frequency of \SI{98.99}{\mega\hertz}. Check matched the target specifications.

After that, we build the close loop circuit in MULTISIM by adding a 2pF capacitor as the load of the previous open loop circuit shown in Fig.\ref.
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{Close Loop.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{0.9.png}}
\caption{$V_{CM}= 0.9V$for Closed Loop circuit}
\label{fig:close_loop_0.9V}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{1.5.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{4 Bit.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.35\textwidth]{structure.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{saturation.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{h000.png}}
\caption{Vout with input 000}
\label{fig:output_000}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{h001.png}}
\caption{Vout with input 001}
\label{fig:output_001}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{h010.png}}
\caption{Vout with input 010}
\label{fig:output_010}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{h011.png}}
\caption{Vout with input 011}
\label{fig:output_011}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{h100.png}}
\caption{Vout with input 100}
\label{fig:output_100}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{h101.png}}
\caption{Vout with input 101}
\label{fig:output_101}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{h110.png}}
\caption{Vout with input 110}
\label{fig:output_110}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{h111.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{curve.png}}
\caption{DAC Transfer Characteristic}
\label{fig:result1}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{curve1.png}}
\caption{$V_{out}$ Linearity}
\label{fig:result2}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{DNL.png}}
\caption{DNL}
\label{fig:DNL}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{INL.png}}
\caption{INL}
\label{fig:INL}
\end{figure}
\newpage
...
The proposed OTA achieves \SI{41.5}{\deci\bel} DC gain and a \SI{98.99}{\mega\hertz} unity-gain bandwidth at a \SI{20}{\micro\ampere} bias, enabling accurate current-to-voltage conversion for the R-2R ladder. \\
